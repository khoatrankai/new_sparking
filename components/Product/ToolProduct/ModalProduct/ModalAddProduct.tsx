...
const ModalAddProduct = ({ refBtnProduct }: Props) => {
  ...
  const refBtnSupplier = useRef<HTMLButtonElement>(null);
  const refBtnBrand = useRef<HTMLButtonElement>(null);
  const refBtnOriginal = useRef<HTMLButtonElement>(null);
  const refBtnUnit = useRef<HTMLButtonElement>(null);
