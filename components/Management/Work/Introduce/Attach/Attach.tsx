...
import { IGetFile, IGetFolder, IGetWork2 } from '@/models/activityInterface';
...
export default function Attach() {
    ...
    const refBtnFolder = useRef<HTMLButtonElement>(null)
    const refBtnFile = useRef<HTMLButtonElement>(null)
