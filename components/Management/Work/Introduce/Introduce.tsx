...
export default function Introduce() {
    ...
    const refBtnAddReview = useRef<HTMLButtonElement>(null)
    const refBtnHistoryReview = useRef<HTMLButtonElement>(null)
    const refBtnWork = useRef<HTMLButtonElement>(null)
    const refBtnListTask = useRef<HTMLButtonElement>(null)
