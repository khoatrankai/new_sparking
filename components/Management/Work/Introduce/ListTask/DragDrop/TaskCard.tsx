...
import { IGetTask } from "@/models/activityInterface";
import ModalUpdateTask from "@/components/Task/Tool/Modal/ModalUpdateTask/ModalUpdateTask";
    ...
    <Draggable key={item.task_id} draggableId={item.task_id} index={index}>
      {(provided) => {
        ...
        return (
          ...
          >
            <TaskInformation
              className="shadow-[0px_2px_3px_-1px_rgba(0,0,0,0.1),0px_1px_0px_0px_rgba(25,28,33,0.02),0px_0px_0px_1px_rgba(25,28,33,0.08)] min-w-full"
              onClick={() => {
