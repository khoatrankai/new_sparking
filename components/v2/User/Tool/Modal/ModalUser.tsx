...
import ModalGroupUser from "@/components/User/Tool/Modal/ModalGroupUser/ModalGroupUser";

type Props = {
  refBtnAdd?:Ref<HTMLButtonElement>
}

export default function ModalAddUser({refBtnAdd}:Props) {
  const dispatch = useDispatch<AppDispatch>();
  const refBtnGroup = useRef<HTMLButtonElement>(null);
