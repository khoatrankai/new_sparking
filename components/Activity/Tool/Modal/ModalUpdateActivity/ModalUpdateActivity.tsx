...
export default function ModalUpdateActivity({
  ...
  const refBtnType = useRef<HTMLButtonElement>(null);
  const refBtnContract = useRef<HTMLButtonElement>(null);
  const refBtnStatus = useRef<HTMLButtonElement>(null);
  const refBtnTypeWork = useRef<HTMLButtonElement>(null);
  const refBtnStatusWork = useRef<HTMLButtonElement>(null);
  const refBtnUpdateWork = useRef<HTMLButtonElement>(null);
