...
export default function TagWorkPage() {
  ...
  const [nameTagEdit,setNameTagEdit] = useState<string>()
  ...
  const handleDelete = async () => {
      const statusCode = await postdata(() =>
        activityService.deleteTag(selectedTasks)
      );
      if (statusCode === 200) {
  ...
  useEffect(()=>{
    if(idPermission && tagWork){
      refBtnPermission.current?.click()
    }
  },[idPermission,tagWork])
  // useEffect(()=>{
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-white border-b border-gray-200 px-6 py-4">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-2xl font-bold text-gray-900">Quản lý tag công việc</h1>
            <p className="text-gray-600">Tổ chức và quản lý các tag</p>
          </div>
      ...
      <div className="p-6 space-y-6">
          ...
          <Card>
            <CardContent className="p-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-sm text-gray-600">Tổng tag</p>
          ...
          <Card>
            <CardContent className="p-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-sm text-gray-600">Tổng công việc gắn tag</p>
          ...
          <Card>
            <CardContent className="p-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-sm text-gray-600">Hiệu suất Tag</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {tags.map((dept,index) => (
            <Card key={dept.tag_id || index} className="hover:shadow-lg transition-shadow">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <DropdownMenu>
                      ...
                      <DropdownMenuContent align="end">
                        <DropdownMenuItem onClick={() => {setIdEdit(dept.tag_id)
                          setNameEdit(dept.name)
                          setNameTagEdit(dept.name_tag)
                        }}>
                          Sửa
                        </DropdownMenuItem>
                        <DropdownMenuItem 
                          onClick={() => {
                            setSelectedTasks([dept?.tag_id ?? ""])
              ...
              <CardContent className="space-y-4">
                <div className="grid grid-cols-2 gap-4 text-sm">
                  ...
                  <div>
                    ...
                    <p className="font-medium text-gray-900">{dept?.works?.length} người</p>
                  </div>
                  {/* <div>
      ...
      <ModalUpdateTag ID={idEdit} name={nameEdit} name_tag={nameTagEdit} refBtnUpdate={refBtnEdit}/>
      <ModalAddTag refBtnAdd={refBtnAdd}/>
      <Modal
