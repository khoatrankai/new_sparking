          ...
          <Card>
            <CardContent className="p-6">
              <div className="text-center mb-6">
                ...
                <p className="text-sm text-gray-500">Mã nhân viên: {employee.employeeId}</p>
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center gap-3 text-sm">
                  ...
                  <span className="ml-auto text-gray-900">{employee.contact.email}</span>
                </div>

                <div className="flex items-center gap-3 text-sm">
                  <Phone className="w-4 h-4 text-gray-400" />
                  <span className="text-gray-600">Ngày sinh</span>
                  <span className="ml-auto text-gray-900">{employee.contact.birthDate}</span>
                </div>

                <div className="flex items-center gap-3 text-sm">
                  <Phone className="w-4 h-4 text-gray-400" />
                  <span className="text-gray-600">Số điện thoại</span>
                  <span className="ml-auto text-gray-900">{employee.contact.phone}</span>
                </div>

                <div className="flex items-center gap-3 text-sm">
                  <MapPin className="w-4 h-4 text-gray-400" />
                  <span className="text-gray-600">Quê quán</span>
                  <span className="ml-auto text-gray-900">{employee.contact.address}</span>
                </div>
                    ...
                    <div key={index} className="flex items-center gap-3">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="w-full bg-gray-200 rounded-full h-1 mt-1">
                          <div className={`h-1 rounded-full ${achievement.color}`} style={{ width: "90%" }}></div>
                        </div>
                      </div>
                    </div>
                  ))}
